...
function Mebel() {
  ...
  useEffect(()=>{
      ...
      : furnitureData;
      const filterPrice=filteredFurniture.filter((item)=>{ return (item.price>minPrice && item.price<maxPrice)} )
  ...
  return (
    <div className="container">
     <div>
      ...
      <button className="btn-cat" onClick={() => handleCategoryFilter("wardrobe")}>Wardrobe</button>
      <button className="btn-cat" onClick={() => handleCategoryFilter("almirah")}>Almirah</button>
